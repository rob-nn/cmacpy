...
class TestCmac(unittest.TestCase):
    ...
    def test_get_weight_table(self):
        self.assertTrue(self._cmacpy.get_weight(41212) != 0)
        self.assertTrue(self._cmacpy.get_weight(0) != 0)
        self.assertTrue(self._cmacpy.get_weight(10109) != 0)
        self.assertTrue(self._cmacpy.get_weight(30307) != 0)

        self.assertTrue(self._cmacpy.get_weight(-1) != 0)

    def test_get_weight_table(self):
        self._cmacpy.set_weight(41212, 55)
        self.assertTrue(self._cmacpy.get_weight(41212) == 55)
	...
	self.assertTrue(self._cmacpy.get_discretized_value_index(0.25, self._sense_conf_2) == 1)
	self.assertTrue(self._cmacpy.get_discretized_value_index(1., self._sense_conf_2) == 9)
	self.assertTrue(self._cmacpy.get_discretized_value_index(5, self._sense_conf_2) == 9)
	self.assertTrue(self._cmacpy.get_discretized_value_index(0.1, self._sense_conf_2) == 0)
	self.assertTrue(self._cmacpy.get_discretized_value_index(0, self._sense_conf_2) == 0)
	self.assertTrue(self._cmacpy.get_discretized_value_index(0.95, self._sense_conf_2) == 8)
	self.assertTrue(self._cmacpy.get_discretized_value_index(0.4, self._sense_conf_2) == 3)
	...
	self.assertTrue(np.all(self._cmacpy.calculate_activation_adresses([12., 1., 1.])== np.array([41212, 10913, 21014, 31115])))
	self.assertTrue(np.all(self._cmacpy.calculate_activation_adresses([0,0,0])== np.array([0, 10101, 20202, 30303])))
	self.assertTrue(np.all(self._cmacpy.calculate_activation_adresses([5.25, 0.37, -0.2])== np.array([408, 10505, 20206, 30307])))
	self.assertTrue(self._cmacpy.get_weight(41212) != 0)
	self.assertTrue(self._cmacpy.get_weight(10913) != 0)
	self.assertTrue(self._cmacpy.get_weight(21014) != 0)
	self.assertTrue(self._cmacpy.get_weight(31115) != 0)
	self.assertTrue(self._cmacpy.get_weight(10101) != 0)
	self.assertTrue(self._cmacpy.get_weight(20202) != 0)
	self.assertTrue(self._cmacpy.get_weight(30303) != 0)
	self.assertTrue(self._cmacpy.get_weight(408) != 0)
	self.assertTrue(self._cmacpy.get_weight(10505) != 0)
	self.assertTrue(self._cmacpy.get_weight(20206) != 0)
	self.assertTrue(self._cmacpy.get_weight(30307) != 0)
	self.assertTrue(self._cmacpy.fire([4, 0.3, -0.5]) != 0)
...
class TestTrain(unittest.TestCase):
    ...
    def test_train_one_conf(self): 
        ...
        _train = cmacpy.Train(ann, np.random.uniform(-10, 10, 500), np.random.uniform(0, 1000, 500), 0.5, 50)
